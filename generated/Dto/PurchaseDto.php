...
class PurchaseDto extends AbstractDto
{
     ...
     * @param bool $touched
     *
     * @return array{method: string, currency: string|null, amount: int|float, orderId: string, channel: string|null, customer: array{email: string, firstName: string|null, lastName: string|null, phoneNumber: string|null}, url: array{callbackUrl: string|null, successUrl: string|null, failedUrl: string|null}}
     */
    public function toArray(?string $type = null, ?array $fields = null, bool $touched = false): array
    {
        /** @var array{method: string, currency: string|null, amount: int|float, orderId: string, channel: string|null, customer: array{email: string, firstName: string|null, lastName: string|null, phoneNumber: string|null}, url: array{callbackUrl: string|null, successUrl: string|null, failedUrl: string|null}} $result */
    ...
    /**
     * @param array{method: string, currency: string|null, amount: int|float, orderId: string, channel: string|null, customer: array{email: string, firstName: string|null, lastName: string|null, phoneNumber: string|null}, url: array{callbackUrl: string|null, successUrl: string|null, failedUrl: string|null}} $data
